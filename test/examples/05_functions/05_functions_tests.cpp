...
TEST_CASE("Test non static function", "value of num will not persist across function")
{
...
TEST_CASE("Test static_2 function", "value of num_2 is different across function calls")
{
