...
TEST_CASE("Test the add to double 1 function", "testing the decimal insconsistencies") 
{
	//REQUIRE(.9== add_to_double_1(0));
}

/*test case add_to_double_1 with 1 as parameter*/
TEST_CASE("Test the add to double 2 function", "testing the decimal insconsistencies") 
{
...
TEST_CASE("Test the boolean operator order of precedence", "order of operations")
{
